  ...
  return (
    <>
      <div
        ...
        style={{
          color: props.darkMode === "light" ? "#000" : "#00ffff",
          backgroundColor: props.darkMode === "light" ? "#fff" : "#000020",
        }}
        id="accordionExample"
      >
        <div
          ...
          style={{
            color: props.darkMode === "light" ? "#000" : "red",
            backgroundColor: props.darkMode === "light" ? "#fff" : "#000020",
          }}
        >
          <h2 className="accordion-header" id="headingOne">
            <button
              style={{
                color: props.darkMode === "light" ? "#000" : "red",
                backgroundColor:
                  props.darkMode === "light" ? "#fff" : "#161010",
              }}
          ...
          >
            <div className="accordion-body">
              <strong>This is #161010 the first item's accordion body.</strong>{" "}
